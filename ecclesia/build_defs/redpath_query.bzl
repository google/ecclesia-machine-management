...
def redpath_query(name, cc_namespace, queries, query_rules = [], extension_files = [], visibility = None, generator = "//ecclesia/lib/redfish/dellicius/query:query_spec_generator"):
    ...
    Args:
      ...
      extension_files: list of extension files to be embedded into a cc_library.
    ...
    native.filegroup(
        ...
        srcs = queries + query_rules + extension_files,
    )
