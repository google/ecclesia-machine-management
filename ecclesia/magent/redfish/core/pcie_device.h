...
#ifndef ECCLESIA_MAGENT_REDFISH_INDUS_PCIE_DEVICE_H_
#define ECCLESIA_MAGENT_REDFISH_INDUS_PCIE_DEVICE_H_
...
#endif  // ECCLESIA_MAGENT_REDFISH_INDUS_PCIE_DEVICE_H_
