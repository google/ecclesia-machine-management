...
#ifndef ECCLESIA_MAGENT_REDFISH_COMMON_UPDATE_SERVICE_H_
#define ECCLESIA_MAGENT_REDFISH_COMMON_UPDATE_SERVICE_H_
...
#endif  // ECCLESIA_MAGENT_REDFISH_COMMON_UPDATE_SERVICE_H_
