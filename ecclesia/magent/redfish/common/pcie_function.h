...
#ifndef ECCLESIA_MAGENT_REDFISH_COMMON_PCIE_FUNCTION_H_
#define ECCLESIA_MAGENT_REDFISH_COMMON_PCIE_FUNCTION_H_
...
#endif  // ECCLESIA_MAGENT_REDFISH_COMMON_PCIE_FUNCTION_H_
