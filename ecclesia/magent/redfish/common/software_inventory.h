...
#ifndef ECCLESIA_MAGENT_REDFISH_COMMON_SOFTWARE_INVENTORY_H_
#define ECCLESIA_MAGENT_REDFISH_COMMON_SOFTWARE_INVENTORY_H_
...
class SoftwareInventoryCollection : public Resource {
 public:
  SoftwareInventoryCollection() : Resource(kSoftwareInventoryCollectionUri) {}
...
#endif  // ECCLESIA_MAGENT_REDFISH_COMMON_SOFTWARE_INVENTORY_H_
