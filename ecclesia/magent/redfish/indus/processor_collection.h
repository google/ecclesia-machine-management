...
#ifndef ECCLESIA_MAGENT_REDFISH_INDUS_PROCESSOR_COLLECTION_H_
#define ECCLESIA_MAGENT_REDFISH_INDUS_PROCESSOR_COLLECTION_H_
...
#endif  // ECCLESIA_MAGENT_REDFISH_INDUS_PROCESSOR_COLLECTION_H_
