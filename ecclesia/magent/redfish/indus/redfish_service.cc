...
#include "ecclesia/magent/redfish/indus/log_service.h"
#include "ecclesia/magent/redfish/indus/log_service_clear.h"
#include "ecclesia/magent/redfish/indus/log_services.h"
...
IndusRedfishService::IndusRedfishService(
  ...
  resources_.push_back(CreateResource<LogServiceCollectionIndus>(server));
  resources_.push_back(CreateResource<LogService>(server));
  resources_.push_back(CreateResource<LogServiceClear>(server));
