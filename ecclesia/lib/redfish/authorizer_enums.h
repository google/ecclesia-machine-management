...
enum class ResourceEntity : int {
  ...
  kAmdPostPackageRepair,
  kAmdPostPackageRepairConfig,
  kAmdPostPackageRepairStatus,
  kAssembly,
  kBattery,
  kBatteryCollection,
  kBatteryMetrics,
  ...
  kGoogleAuthorizationConfig,
  kGoogleAuthorizationPrivilegeRegistry,
  kGoogleBareMetalInstance,
  kGoogleBmcNfMetrics,
  kGoogleBmcSocketMetrics,
  kGoogleBootNumber,
  kGoogleBootTime,
  kGoogleErrorCounter,
  ...
  kNvidiaPowerSmoothingPresetProfile,
  kNvidiaPowerSmoothingPresetProfileCollection,
  kNvidiaRoTImageSlot,
  kNvidiaRoTImageSlotCollection,
  kNvidiaRoTProtectedComponent,
  kNvidiaRoTProtectedComponentCollection,
  kNvidiaRoTProtectedComponentSettings,
  kNvidiaSwitchPowerMode,
  kNvidiaWorkloadPower,
  kNvidiaWorkloadPowerProfile,
  kNvidiaWorkloadPowerProfileCollection,
  kOperatingConfig,
  ...
  kTlBMCDebugStore,
  kTlBMCDebugStoreSharedMemorySensors,
  kTlBMCMetrics,
  kTlBMCSchedulerStats,
  kTlBMCServiceRoot,
  kTpuManagerDevice,
  kTpuManagerDeviceCollection,
  kTpuManagerDeviceMetrics,
  kTpuManagerServiceRoot,
  kTriggers,
  kTriggersCollection,
  kTrustedComponent,
