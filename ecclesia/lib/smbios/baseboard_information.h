...
#ifndef ECCLESIA_LIB_SMBIOS_BASEBOARD_INFORMATION_H_
#define ECCLESIA_LIB_SMBIOS_BASEBOARD_INFORMATION_H_
...
class BaseboardInformation {
 public:
  ...
  // Get a message view that represents the BaseBoardInformationStructure
  // defined in smbios_structures.emb.
  BaseboardInformationStructureView GetMessageView() const {
    return table_entry_->GetSmbiosStructureView().baseboard_information();
  }
...
#endif  // ECCLESIA_LIB_SMBIOS_BASEBOARD_INFORMATION_H_
